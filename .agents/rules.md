...
3. Check `AIE_Project_Edit_Log_v2.0.md` — latest progress and pending items.
...
4. **Edit Log Discipline:** Record all changes in `AIE_Project_Edit_Log_v2.0.md` with accurate timestamps. Historical log: `AIE_Project_Edit_Log_v1.0.md` (Phase 1–5, SEALED — read-only).
...
| `AIE_Project_Edit_Log_v2.0.md` | Active change log (Maintenance phase) |
| `AIE_Project_Edit_Log_v1.0.md` | Archived change log (Phase 1–5, SEALED) |
