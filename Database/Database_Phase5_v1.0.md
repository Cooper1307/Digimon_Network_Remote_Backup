# AIE Project Database: Phase 5 (v1.0)

## 1. Characters & Entities [NEW/UPDATED]

### The Raiders (攻略组) & Royal Knights (皇家骑士团)

- **Zero (Zero/杰斯兽 GX)**: [NEW] US Network Spy. Disciple of Gankoomon. Wields "Endless Gauntlet."
- **Gankoomon (顽固兽)**: [NEW] Zero's mentor. Traditionalist and powerful. Sacrificed himself for Zero.
- **Sistermon Noir/Blanc (修女兽·漆黑/雪白)**: [NEW] Gankoomon's assistants. Revealed as human girls in reality.
- **LordKnightmon (Judith/剑皇兽)**: [NEW] Daughter of Zachary Lopez. Zero's rival/partner.
- **Craniummon (Defense Minister/颅骨兽)**: [NEW] Antagonist for Zero. Corrupt official.
- **Duftmon (Zachary Lopez/芳香兽)**: [NEW] Zero's superior. Betrayer.
- **Jesmon (杰斯兽)**: Base form of Zero. Capable of creating "Zero Domain" (零域).
...
- **VictoryGreymon (Owl/胜利暴龙兽)**: [NEW] Strategic evolution of Owl (BlackWarGreymon) using the "Seed of Promotion."
- **Rosemon: Burst Mode (Sakura/蔷薇兽：爆裂形态)**: [NEW] High-魅惑 (Charm) form. Used to peacefully neutralize conflicts.

## 2. World-Building & Lore

### Locations

- **Deep Sea Temple (深海神殿)**: Private domain of Neptunemon/Atlantis.
- **Mountain Habitat (山栖原)**: Neutral ground for the "Bird-Beast Conflict."
- **Hephaestus Workshop (赫菲斯托斯工房)**: Master Changsun's legendary forge.
