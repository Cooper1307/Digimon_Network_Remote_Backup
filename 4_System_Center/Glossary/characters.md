# Glossary: Characters & Entities

Sourced from `Glossary_v1.0.md` §1. For incremental additions, update this file and sync back to the master glossary.
...
| 幽冥俱乐部 | Nether Club | Guild | "Nether" fits the dark fantasy tone. |
| 突变研究所 | Mutant Research Lab | Guild | Scientific/Industrial tone. |
| 亚特兰蒂斯 | Atlantis | Guild | Mythological water realm. |
| 喝一杯酒吧 | The 'Drink' Bar | Guild | Modified for tavern feel. |
