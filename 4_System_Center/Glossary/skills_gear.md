# Glossary: Skills & Gear

Sourced from `Glossary_v1.0.md` §3. For incremental additions, update this file and sync back to the master glossary.

| Source (CN) | Literal | Official | Project Decision | Reason |
| --- | --- | --- | --- | --- |
| 荆棘之鞭 | Thorn Whip | Thorn Whip | **Thorn Whip** | Exact match. |
| 死光霹雳剑 | Deadly Ray Thunderbolt Sword | Dark Spirits Deluxe | **Giga Blaster: Deadly Ray** | Hybrid. |
| 全金属臀击 | Full Metal Hip Attack | Full Metal Hip Attack | **Full Metal Hip Attack** | Exact match. |
| 天下第一拳 | Number One Punch | Number One Punch | **World's Strongest Punch** | More impact. |
...
| 禁断诱惑 | Forbidden Temptation | Forbidden Temptation | **Forbidden Temptation** | Official. Rosemon's attack. |
