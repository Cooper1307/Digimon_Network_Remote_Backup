# Glossary: Digimon & Evolution Levels

Sourced from `Glossary_v1.0.md` §2. For incremental additions, update this file and sync back to the master glossary.

## Evolution Levels

| Source (CN) | Official (US) | Project Standard |
| --- | --- | --- |
| 究极体 | Mega Level | **Mega Level** |
| 完全体 | Ultimate Level | **Ultimate Level** |
| 成熟期 | Champion Level | **Champion Level** |
| 成长期 | Rookie Level | **Rookie Level** |
...
| 普路托兽 | Plutomon | **Plutomon** | Official. The mastermind. |
